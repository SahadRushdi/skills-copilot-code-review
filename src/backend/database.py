...
initial_announcements = [
    {
        "_id": "activity-registration-open",
        "title": "Activity Registration Is Open",
        "message": "Registration is now open for all extracurricular activities. Review schedules and reserve your spots before they fill up.",
        "start_date": None,
